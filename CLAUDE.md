...
Для v2 (ИИ-обогащение) добавлены: google-antigravity SDK (agy), PostgreSQL 15+ (с pgvector), sentence-transformers, asyncpg, и pydantic-settings.
...
Выполнен промпт 18: Клиент Antigravity (agy) и пайплайн обогащения в `app/ai/enrichment.py`. Реализована обёртка над API google-antigravity с санированием ответа через шорт-лист кандидатов и кэшированием результатов.
