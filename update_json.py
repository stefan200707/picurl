...
def update_file(path, new_items):
    ...
    for item in new_items:
        ...
        if slug in existing_slugs:
            # Update existing
            existing_slugs[slug]["aliases"] = list(set(existing_slugs[slug].get("aliases", []) + item.get("aliases", [])))
        else:
            data.append(item)
...
option_groups = [
    {"name": "Уникальная квартира", "slug": "unikalnayaKvartira", "aliases": ["уникальная квартира", "уникальная", "необычная квартира"]},
    ...
    {"name": "Мастер-спальня", "slug": "masterbedroom", "aliases": ["мастер-спальня", "мастер спальня", "со своей ванной"]},
    {"name": "Разнесённые спальни", "slug": "spacedbedrooms", "aliases": ["разнесенные спальни", "разнесённые спальни", "изолированные спальни"]},
    {"name": "Два и более санузла", "slug": "manybathrooms", "aliases": ["два санузла", "несколько санузлов", "2 санузла"]},
    {"name": "Сквозной санузел", "slug": "throughbathroom", "aliases": ["сквозной санузел", "проходной санузел"]},
    {"name": "Терраса", "slug": "terrasa", "aliases": ["терраса", "с террасой"]},
    {"name": "Балкон", "slug": "balcony", "aliases": ["балкон", "с балконом", "лоджия", "с лоджией"]},
    ...
    {"name": "Окно в ванной", "slug": "bathroomwindow", "aliases": ["окно в ванной", "с окном в ванной"]},
    ...
    {"name": "Внутрипольные конвекторы", "slug": "trenchconvectors", "aliases": ["внутрипольные конвекторы", "конвекторы в полу"]}
]

options = [
    {"name": "Вид на школу", "slug": "vidNaShkolu", "aliases": ["вид на школу", "с видом на школу"]},
    {"name": "Вид на воду", "slug": "vidNaVodu", "aliases": ["вид на воду", "вид на реку", "с видом на воду"]},
    ...
    {"name": "Вид на дорогу", "slug": "vidNaDorogu", "aliases": ["вид на дорогу", "с видом на дорогу"]}
]
