...
def test_is_within():
    # Одинаковые точки — попадают в любой неотрицательный радиус
    assert is_within(55.7558, 37.6173, 55.7558, 37.6173, 0.0) is True
    # Москва - Питер, 100 км мало
    assert is_within(55.7558, 37.6173, 59.9343, 30.3351, 100_000) is False
    # Москва - Питер, 700 км хватает
